                                    ...
                                    if(ays_pb_scrollTop_".$id." == 0){
                                        ...
                                        let timer_pb_".$id." = setInterval(function(){
                                            ...
                                            $(document).find('.ays-pb-modal-close_".$id."').one('click', function(){ 
                                                ...
                                                $(document).find('.ays-pb-modal_".$id."').attr('class', '".$modal_class." ".$ays_pb_show_scrollbar_class." ays-pb-modal_".$id." ".$custom_class." '+ays_pb_effectOut_".$id.");
                                ...
                                if(time_pb_".$id." !== undefined){ 
                                 if(time_pb_".$id." !== 0){
                                    var timer_pb_".$id." = setInterval(function(){
                                        ...
                                        $(document).find('.ays-pb-modal-close_".$id."').one('click', function(){
                                            $(document).find('.av_pop_modals_".$id."').css('pointer-events', 'none');
                                            $(document).find('.ays-pb-modal_".$id."').attr('class', '".$modal_class." ays-pb-modal_".$id." ".$ays_pb_show_scrollbar_class."  ".$custom_class." '+ays_pb_effectOut_".$id.");
                                            $(this).parents('.ays-pb-modals').find('iframe').each(function(){
                                                var key = /https:\/\/www.youtube.com/;
                                                var src = $(this).attr('src');
                                                $(this).attr('src', $(this).attr('src'));
